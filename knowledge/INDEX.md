...
|--------------|---------|---------|
| Product features & constraints | `knowledge/product/PRODUCT.md` | "What features exist?" |
| Past mistakes & wins | `knowledge/lessons-learned.md` | "Have we seen this before?" |
...
## Quick Links
- [Product Map](product/PRODUCT.md) — Features, design decisions, constraints
- [Lessons Learned](lessons-learned.md) — Mistakes and wins
...
---
*Index version: 3.0 — Updated for Framework v3*
